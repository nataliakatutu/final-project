...
const openMaps = () => {
  Linking.openURL('https://goo.gl/maps/6L2AJaMTJ1A9Uaaw8');
};
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardContent}>
            Pulau Pulau Lihaga merupakan salah satu pulau tak berpenghuni yang
            masuk dalam wilayah administrasi Kecamatan Likupang, Kabupaten
            Minahasa Utara, Sulawesi Utara. Luas Pulau Lihaga sekitar 8 hektar.
            Lokasi pulau tidak terlalu jauh dari Pulau Gangga dan Bunaken.
          </Text>
          <View style={styles.ratingContainer}>
            <Waktu style={styles.ikon} />
            <Text style={styles.ikoText}> Waktu Kunjungan:</Text>
            <Text style={styles.ikoTextWaktu}>Buka 24 jam</Text>
          </View>
          <View style={styles.ratingContainer}>
